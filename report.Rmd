...
Our purpose is to **determine whether the acquisition of Electronidex is convenient for Blackwell Electronics**. To do so, we want to understand the overlapping or lack thereof of customer and products base for both companies.
...
First and foremost, we understand that Blackwell Electronics is considering boosting its online market share, specially in the West region. For that matter, the acquisition of Electronidex could be a valuable asset, given all its sales are made through that channel and it could add a lot of experience to the company.
...
<!-- Sobre reglas de asociacion:
Hemos encontrado reglas de asociacion para el segmento de clientes “business” (min support 10%, min confidence 50%):
Con un lift de 1.46, encontramos que los clientes que compran el monitor Viewsonic, tambien adquieren HP Laptop
Con un lift de 1.18, encontramos que los clientes que compran el monitor Viewsonic, tambien adquieren iMac
Por tanto, recomendamos la venta del monitor Viewsonic. -->
...
<!-- No hemos encontrado reglas relevantes para el segmento de clientes “retail” (min support 8%, min confidence 50%).
No obstante, encontramos una regla relevante pero poco aclaratoria dentro del subgrupo “fanboy”. Con un lift de 1.85, aquellos clientes que adquieren un cable de carga para iPhone, adquieren un Macbook Air, pero no obtenemos la regla inversa -->
